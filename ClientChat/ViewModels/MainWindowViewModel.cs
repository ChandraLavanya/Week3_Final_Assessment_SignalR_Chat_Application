...
namespace ClientChat.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private UserModels _userMode;
        public UserModels UserMode
        {
        ...
        private async Task<bool> Login()
        {
            try
            {
                ...
                if (users != null)
                {
                    ...
                    UserMode = UserModels.Chat;
                    IsLoggedIn = true;
                    return true;
                }
                else
                {
                    dialogService.ShowNotification("This User already Exists");
                    return false;
                }
